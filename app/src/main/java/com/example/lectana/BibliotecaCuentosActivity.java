...
public class BibliotecaCuentosActivity extends AppCompatActivity implements AdaptadorCuentosDisponibles.OnCuentoSeleccionadoListener {
    ...
    private void cargarDatosEjemplo() {
        // Ya no usamos datos hardcodeados, todo desde la API
        listaCuentosCompleta = new ArrayList<>();
        listaCuentosFiltrada = new ArrayList<>();
        
        mostrarError("No se pudieron cargar los cuentos. Por favor, verifica tu conexión.");
        android.util.Log.w("BibliotecaCuentos", "Fallback a datos de ejemplo eliminado - solo usar API");
    }
